...
export const CARD_TEXT: Record<string, string> = {
  WR1: "<b>开战</b>：对手每下注或加注一次，攻 +2",
  WR2: "每被<b>打中</b>一段（含反击），攻 +1",
  WR3: "对手下过注：<b>第 1 轮</b>出手伤害翻倍",
  GR1: "<b>开战</b>：每投入 10 筹码 +1/+1（最多 +4）",
  GR2: "<b>开战</b>：每付一次操作费，屏障 +1",
  GR3: "<b>击倒</b>敌人：攻 +2，得它装备的攻、血",
  GL1: "<b>吸血</b>：自己出手每打中一段，回 1 血",
  GL2: "布阵时可<b>吞掉</b>一名队友，获得它的攻和血",
  GL3: "每<b>倒下</b>一人（不论敌我）：+1/+3",
  EN1: "亮牌后<b>偷看</b>对手一张暗牌，可换自己两张暗牌",
  EN2: "<b>开战</b>：照搬对位的形状，攻取较高",
  EN3: "<b>开战</b>：拿走对位的装备",
  SL1: "<b>开战</b>：你每过牌一次，血 +4",
  SL2: "<b>第 1 轮沉睡</b>；每过牌一次，攻 +2",
  SL3: "你没付过操作费：<b>开战</b>全队血 +5",
  PR1: "<b>被亮出</b>：开战时 +3/+4",
  PR2: "<b>满血</b>时出手伤害翻倍",
  PR3: "<b>被亮出</b>：对手第 1 轮下注不能弃牌",
  LU1: "<b>守护</b>：敌人打它相邻的队友时，改打它",
  LU2: "<b>开战</b>：与对位缔结，两人不出手不反击",
  LU3: "<b>开战</b>：对位第 1 轮改打身边的队友",
  WR4: "第一次<b>打掉敌人屏障</b>后，攻 +2",
  GR4: "<b>开战</b>：剩余筹码多于对手，屏障 +1",
  GL4: "打中敌人：它<b>护甲 -1</b>（每人一次）",
  GL5: "敌方<b>只剩一人</b>时出手伤害 +4",
  EN4: "攻击<b>被亮出</b>的敌人时出手伤害 +2",
  SL4: "<b>第 3 轮</b>起出手伤害 +3",
  LU4: "打中它的敌人：<b>下一次攻击 -2</b>（每人一次）",
  LU5: "站 <b>2 号位</b>且两侧有人：<b>开战</b>全队血 +2",
};
...
<ol>
  ...
  <li><b>布阵</b>：1、2、3 号位依次各有 3 名候选，分别选 1 名。每个位置最多 D 一次换另一组三张，换掉的旧三张永久不能回来。三个位置选完后亮出其中 1 名；非庄家先布阵、先亮，庄家看到后再布阵，其余人物对手看不到。</li>
  <li><b>第 1 轮下注</b>：过牌、下注、跟注、加注、全押、弃牌，和德州扑克一样。</li>
  <li><b>操作</b>：下注匹配后，双方各自决定要不要付操作费（等于这一轮的下注额，最多不超过双方较少的筹码）。可以付费从 3 件装备里挑 1 件，或付同样费用公开改一次全队攻击指向；两者只能选一个。</li>
...
<ul>
  ...
  <li><b>+X/+Y</b> 表示攻 +X、血 +Y（和卡面底栏一样，左攻右血）。</li>
  <li>人物能力写<b>“攻 +N”</b>的，改的是卡面上的攻，反击也按新的攻打回去；写<b>“出手伤害 +N / 翻倍”</b>的，只加在它自己出手的那一下，卡面的攻和反击都不变。</li>
