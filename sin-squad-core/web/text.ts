...
export const CARD_TEXT: Record<string, string> = {
  ...
  WR4: "第一次<b>打破敌人屏障</b>后，攻 +2",
  GR4: "<b>开战</b>时筹码领先：屏障 +1",
  GL4: "打中带护甲的敌人：它<b>护甲 -1</b>（每人一次）",
  GL5: "敌方<b>只剩一人</b>时攻 +4",
  EN4: "攻击<b>被亮出</b>的敌人时攻 +2",
  SL4: "<b>第三轮</b>起攻 +3",
  LU4: "<b>嘲讽</b>：转线后的敌人优先打它",
  LU5: "站 <b>2 号位</b>且两侧有队友：<b>开战</b>全队血 +2",
};
