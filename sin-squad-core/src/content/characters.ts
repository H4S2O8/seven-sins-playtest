...
export const CHARACTERS: readonly CharacterDef[] = [
  ...
  // 每罪新增 5 人：身材按本核心的比例换算（攻不变、最高 5；血 ×0.58 取整，限 3–13）。能力目前只有文字，战斗里还没有实现。
  ...
  { id: "WR6", name: "复仇印", sin: "愤怒", atk: 2, hp: 10, shape: "heavy", armor: 1, barrier: 0, ability: "每被同一敌人连续命中一次，攻 +1（最多 +3）", tag: "记仇", stage: 1 },
  { id: "WR7", name: "战吼者", sin: "愤怒", atk: 3, hp: 6, shape: "multi", armor: 0, barrier: 1, ability: "开战时己方全队攻 +1", tag: "开场战吼", stage: 2 },
  { id: "WR8", name: "断头台", sin: "愤怒", atk: 5, hp: 4, shape: "heavy", armor: 0, barrier: 0, ability: "攻击生命低于 30% 的目标时攻 +3", tag: "处决", stage: 2 },
  { id: "GR4", name: "利滚利", sin: "贪婪", atk: 2, hp: 9, shape: "heavy", armor: 0, barrier: 0, ability: "每付一次操作费，攻 +1", tag: "复利", stage: 1 },
  { id: "GR5", name: "金库守卫", sin: "贪婪", atk: 2, hp: 12, shape: "heavy", armor: 2, barrier: 0, ability: "筹码领先时获得屏障 +1", tag: "守财", stage: 1 },
  { id: "GR6", name: "赌徒", sin: "贪婪", atk: 4, hp: 6, shape: "multi", armor: 0, barrier: 0, ability: "本手下注或加注过时攻 +2", tag: "押注", stage: 1 },
  { id: "GR7", name: "掠夺商", sin: "贪婪", atk: 3, hp: 8, shape: "heavy", armor: 0, barrier: 1, ability: "击倒敌人后为自己获得屏障 +1", tag: "战利品", stage: 2 },
  { id: "GR8", name: "宝库主", sin: "贪婪", atk: 5, hp: 5, shape: "heavy", armor: 0, barrier: 0, ability: "本手投入超过 30 时攻 +3", tag: "豪掷", stage: 2 },
  { id: "GL4", name: "吞光者", sin: "暴食", atk: 2, hp: 10, shape: "heavy", armor: 0, barrier: 0, ability: "每击倒一名敌人回复 4 血", tag: "进食", stage: 1 },
  { id: "GL5", name: "酸液兽", sin: "暴食", atk: 3, hp: 8, shape: "multi", armor: 0, barrier: 0, ability: "命中护甲目标时使其护甲 -1（每人一次）", tag: "腐蚀", stage: 1 },
  { id: "GL6", name: "饥饿猎犬", sin: "暴食", atk: 4, hp: 6, shape: "heavy", armor: 0, barrier: 0, ability: "攻击生命比自己低的目标时攻 +2", tag: "追食", stage: 1 },
  { id: "GL7", name: "胃囊巨人", sin: "暴食", atk: 1, hp: 13, shape: "heavy", armor: 1, barrier: 0, ability: "受到治疗时额外回复 2", tag: "储能", stage: 2 },
  { id: "GL8", name: "终餐者", sin: "暴食", atk: 5, hp: 7, shape: "multi", armor: 0, barrier: 0, ability: "敌方只剩一人时攻 +4", tag: "终餐", stage: 2 },
  { id: "EN4", name: "偷心者", sin: "嫉妒", atk: 2, hp: 9, shape: "multi", armor: 0, barrier: 0, ability: "对位敌人获得装备时，自己攻 +2", tag: "眼红", stage: 1 },
  { id: "EN5", name: "复写匠", sin: "嫉妒", atk: 2, hp: 8, shape: "heavy", armor: 0, barrier: 1, ability: "开战时复制对位敌人的护甲或屏障较高者的一项", tag: "复写", stage: 1 },
  { id: "EN6", name: "窥伺刀", sin: "嫉妒", atk: 4, hp: 5, shape: "heavy", armor: 0, barrier: 0, ability: "攻击被亮出的敌人时攻 +2", tag: "看穿", stage: 1 },
  { id: "EN7", name: "夺势者", sin: "嫉妒", atk: 3, hp: 8, shape: "multi", armor: 0, barrier: 0, ability: "敌方攻最高者倒下后全队攻 +2", tag: "夺势", stage: 2 },
  { id: "EN8", name: "镜狱", sin: "嫉妒", atk: 1, hp: 12, shape: "heavy", armor: 1, barrier: 1, ability: "对位敌人攻越高，自己获得等量最多 +3 攻", tag: "镜牢", stage: 2 },
  { id: "SL4", name: "慢钟", sin: "怠惰", atk: 2, hp: 11, shape: "heavy", armor: 1, barrier: 0, ability: "第一轮受到伤害 -2（最低 1）", tag: "拖延", stage: 1 },
  { id: "SL5", name: "躺赢者", sin: "怠惰", atk: 1, hp: 10, shape: "multi", armor: 0, barrier: 1, ability: "本手没有下注时获得攻 +2、血 +6", tag: "躺赢", stage: 1 },
  { id: "SL6", name: "缓行者", sin: "怠惰", atk: 3, hp: 9, shape: "heavy", armor: 1, barrier: 0, ability: "每轮第一次受到攻击后下一轮攻 +2", tag: "蓄力", stage: 1 },
  { id: "SL7", name: "休眠守卫", sin: "怠惰", atk: 2, hp: 13, shape: "heavy", armor: 2, barrier: 0, ability: "满血时获得屏障 +1", tag: "守眠", stage: 2 },
  { id: "SL8", name: "终止符", sin: "怠惰", atk: 5, hp: 5, shape: "heavy", armor: 0, barrier: 0, ability: "第三轮起攻 +3", tag: "晚钟", stage: 2 },
  { id: "PR4", name: "镀金者", sin: "傲慢", atk: 4, hp: 6, shape: "heavy", armor: 0, barrier: 1, ability: "满血时护甲 +1", tag: "自矜", stage: 1 },
  { id: "PR5", name: "首席", sin: "傲慢", atk: 3, hp: 8, shape: "multi", armor: 0, barrier: 0, ability: "自己亮牌时己方全队攻 +1", tag: "领衔", stage: 1 },
  { id: "PR6", name: "不屈冠军", sin: "傲慢", atk: 2, hp: 12, shape: "heavy", armor: 1, barrier: 0, ability: "第一次低于一半生命时获得屏障 +1", tag: "不屈", stage: 1 },
  { id: "PR7", name: "优越者", sin: "傲慢", atk: 5, hp: 5, shape: "heavy", armor: 0, barrier: 0, ability: "对位敌人攻低于自己时攻 +2", tag: "压制", stage: 2 },
  { id: "PR8", name: "终局王", sin: "傲慢", atk: 4, hp: 8, shape: "multi", armor: 1, barrier: 0, ability: "己方存活人数更多时攻 +2", tag: "王座", stage: 2 },
  { id: "LU4", name: "缠绵者", sin: "色欲", atk: 2, hp: 10, shape: "heavy", armor: 0, barrier: 1, ability: "对位敌人被击倒时为相邻队友回复 4", tag: "余温", stage: 1 },
  { id: "LU5", name: "护心人", sin: "色欲", atk: 1, hp: 13, shape: "heavy", armor: 1, barrier: 0, ability: "相邻队友受到攻击时自己获得屏障 +1", tag: "护心", stage: 1 },
  { id: "LU6", name: "共鸣者", sin: "色欲", atk: 3, hp: 7, shape: "multi", armor: 0, barrier: 0, ability: "相邻队友攻高于自己时，自己攻 +2", tag: "共鸣", stage: 1 },
  { id: "LU7", name: "诱导者", sin: "色欲", atk: 4, hp: 6, shape: "heavy", armor: 0, barrier: 1, ability: "开战时对位敌人优先攻击自己", tag: "诱敌", stage: 2 },
  { id: "LU8", name: "双生誓", sin: "色欲", atk: 3, hp: 10, shape: "multi", armor: 0, barrier: 0, ability: "两侧队友都存活时全队血 +4", tag: "连结", stage: 2 },
];
