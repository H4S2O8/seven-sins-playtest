...
export const ARENAS: readonly ArenaDef[] = [
  { id: "A01", name: "崩落阶梯", kind: "转线", text: "1 号位转线多花一轮；3 号位转线不花时间" },
  { id: "A02", name: "比武场", kind: "对位", text: "打对位时攻击 +1" },
  { id: "A03", name: "积雪内院", kind: "节奏", text: "所有人第 1 轮不出手" },
  { id: "A04", name: "许愿井", kind: "节奏", text: "每人在第一次出手之前，受到的伤害减半" },
  { id: "A05", name: "静默书库", kind: "节奏", text: "第 1 轮所有人物能力失效，装备照常" },
  { id: "A06", name: "巨龙宝库", kind: "节奏", text: "前 2 轮，每段伤害最多扣开战血量的 1/4" },
  { id: "A07", name: "水淹地牢", kind: "伤害", text: "每次伤害额外溅射 1 点到目标相邻的人" },
  { id: "A08", name: "赌徒酒窖", kind: "下注", text: "本手奖池每满 40，所有人攻 +1" },
  { id: "A09", name: "石柱庭院", kind: "屏障", text: "每人开战获得一层屏障" },
  { id: "A10", name: "渗血祭台", kind: "逆转", text: "每人第一次健康度降到 50% 以下时，获得一层屏障" },
  { id: "A11", name: "陋巷", kind: "逆转", text: "开战时各方血最低的人物 +2/+3" },
  { id: "A12", name: "高塔倾覆", kind: "逆转", text: "开战时各方攻最高的人物，本场攻 -3" },
  { id: "A13", name: "黑森林", kind: "逆转", text: "第 1 轮只有各方血最低的人出手" },
  { id: "A14", name: "天平大厅", kind: "逆转", text: "开战时，每方所有人的血改为本方平均值" },
];
