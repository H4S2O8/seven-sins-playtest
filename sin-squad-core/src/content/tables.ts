...
export const RULES: readonly RuleDef[] = [
  ...
  { id: "V13", name: "持续优势", family: "维持压制", maxRounds: 8, text: "整队健康领先 0.75 以上，并保持 1 轮即胜" },
  ...
  { id: "V16", name: "两线推进", family: "维持压制", maxRounds: 8, text: "轮末时三组对位里至少两组健康度领先 0.25 即胜；到时先比赢下的对位组数" },
