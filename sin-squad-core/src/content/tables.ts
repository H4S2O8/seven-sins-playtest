...
export const EQUIPMENT: readonly EquipmentDef[] = [
  ...
  { id: "E02", name: "厚衬背心", text: "+0/+10", effect: { kind: "stat", atk: 0, hp: 10 } },
  { id: "E03", name: "轻摆齿轮", text: "+1/+6", effect: { kind: "stat", atk: 1, hp: 6 } },
  { id: "E04", name: "铁拳套", text: "+2/+4", effect: { kind: "stat", atk: 2, hp: 4 } },
  { id: "E05", name: "行军斗篷", text: "+0/+8，攻 +1", effect: { kind: "stat", atk: 1, hp: 8 } },
  { id: "E06", name: "猎刀", text: "+2/+2", effect: { kind: "stat", atk: 2, hp: 2 } },
...
export const RULES: readonly RuleDef[] = [
  ...
  { id: "V13", name: "持续优势", family: "维持压制", maxRounds: 8, text: "从第 2 轮起，整队健康领先 0.75 以上并连续保持 2 轮即胜" },
  { id: "V14", name: "人数压制", family: "维持压制", maxRounds: 8, text: "存活人数领先，并连续保持 2 轮即胜" },
  { id: "V15", name: "旗手围困", family: "维持压制", maxRounds: 8, text: "敌旗手健康度 ≤ 30% 且己旗手 > 30%，保持 1 轮即胜" },
  { id: "V16", name: "两线推进", family: "维持压制", maxRounds: 8, text: "三组对位里至少两组健康度领先 0.25，保持 1 轮即胜；到时先比赢下的对位组数" },
  { id: "V17", name: "无缺口阵线", family: "维持压制", maxRounds: 8, text: "敌方已有一人倒下，且己方三人健康度都 > 50% 即胜" },
  { id: "V18", name: "绝境突围", family: "维持压制", maxRounds: 8, text: "一方只剩 1 人、另一方至少 2 人时进入突围：孤身者 2 轮内击倒一人就继续打，否则人多者胜" },
  ...
  { id: "V21", name: "整队撤出", family: "限时作战", maxRounds: 4, text: "只打 4 轮；先比存活人数，再比存活者中最低的健康度" },
  { id: "V22", name: "双人撤出", family: "限时作战", maxRounds: 4, text: "只打 4 轮；先比是否至少 2 人存活，再比健康度最高的两人之和" },
  { id: "V23", name: "最后的堡垒", family: "限时作战", maxRounds: 4, text: "只打 4 轮；比各方最高的健康度" },
  { id: "V24", name: "双重火力网", family: "限时作战", maxRounds: 4, text: "只打 4 轮；比对方健康度最低两人之和，打得更低的一方胜" },
  { id: "V25", name: "全面压进", family: "限时作战", maxRounds: 5, text: "只打 5 轮；先比是否让敌方所有人健康度 < 75%，再比整队健康" },
  { id: "V26", name: "终场护旗", family: "限时作战", maxRounds: 5, text: "只打 5 轮，旗手倒下不立即结束；先比旗手是否存活，再比旗手与最健康队友的健康度之和" },
  { id: "V27", name: "不留后患", family: "限时作战", maxRounds: 5, text: "只打 5 轮；比敌方健康度仍 > 50% 的人数，较少者对应的一方胜" },
];
...
export const ARENAS: readonly ArenaDef[] = [
  ...
  { id: "A12", name: "荆棘回廊", kind: "伤害", text: "每人每第 3 次攻击后，自己失去 4 血" },
  { id: "A13", name: "赌徒酒窖", kind: "下注", text: "本手奖池每满 40，所有人攻 +1" },
  { id: "A14", name: "石柱庭院", kind: "形状", text: "每人开战获得一层屏障" },
  { id: "A15", name: "锈蚀检修库", kind: "形状", text: "第 3、6 轮轮末，所有人护甲 -1（最低 0，装备给的不受影响）" },
  ...
  { id: "A19", name: "陋巷", kind: "逆转", text: "开战时各方血最低的人物 +2/+4" },
...
export const PUBLIC_EFFECTS: readonly PublicEffectDef[] = [
  ...
  { id: "P09", name: "深夜霜降", kind: "防护与形状", text: "第 3 轮起，每次攻击额外附带独立的一段 1 点伤害" },
  ...
  { id: "P13", name: "返场时刻", kind: "节奏", text: "第 4 轮，攻击次数少于 3 次的人本轮攻击两次" },
  ...
  { id: "P18", name: "终场冲刺", kind: "节奏", text: "第 5 轮起所有人攻 +1，吸血减半" },
  { id: "P19", name: "枯水", kind: "生命与资源", text: "吸血回复减半" },
  { id: "P20", name: "丰沛", kind: "生命与资源", text: "吸血溢出的部分变成一层屏障（最多 1 层）" },
  { id: "P21", name: "血泉", kind: "生命与资源", text: "每人每累计失去 8 血，回复 2 血" },
  ...
  { id: "P25", name: "疗愈震波", kind: "生命与资源", text: "每累计回复 6 血，对对位敌人造成 2 伤害" },
  ...
  { id: "P29", name: "开场审判", kind: "阵位", text: "开战时各方护甲最高的人受到 4 伤害（不经护甲）" },
  { id: "P30", name: "迟到的庇护", kind: "阵位", text: "第 3 轮开始时，还没掉过血的人获得一层屏障" },
  { id: "P31", name: "碎裂终章", kind: "阵位", text: "第 5 轮起，倒下的人对对位敌人造成 4 伤害" },
];
